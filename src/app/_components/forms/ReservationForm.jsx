    ...
    return (
      <>
        <motion.div className="rsv-success"
          ...
          <p className="rsv-success-phone-note">{t("forChanges")} <a href="tel:+359894766273">+359 89 476 6273</a> · {t("ordersPhoneLabel")} <a href="tel:+359896088804">+359 89 608 8804</a></p>
        </motion.div>
