          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="tst-mb-60">
                <h5
                  className="tst-mb-30 tst-text-shadow"
                  dangerouslySetInnerHTML={{
                    __html: AppData.footer.about.title,
                  }}
                />
                <div
                  className="tst-text tst-text-shadow tst-mb-30"
                  dangerouslySetInnerHTML={{
                    __html: AppData.footer.about.text,
                  }}
                />
                <Link
            ...
            <div className="col-lg-4">
              <div className="tst-mb-60">
                ...
                <Link
                  href={AppData.footer.contact.button.link}
                  className="tst-label tst-color tst-anima-link"
                >
                  {AppData.footer.contact.button.label}
                </Link>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="tst-mb-60">
                <h5
                  className="tst-mb-30 tst-text-shadow"
                  dangerouslySetInnerHTML={{
                    __html: AppData.footer.gallery.title,
                  }}
                />
                <FooterGallery
                  items={AppData.footer.gallery.items}
                  button={AppData.footer.gallery.button}
                />
              </div>
            </div>
          </div>
